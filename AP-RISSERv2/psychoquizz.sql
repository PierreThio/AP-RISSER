...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 17 mars 2023 à 13:48
...
(4, 'Avez-vous déjà fouiné dans votre PC ?', 'Approche', 1, 2, 1),
...
(8, 'Vous ne crachez pas sur le salaire de Dave le dev ? ', 'blabla', 1, 1, 4),
...
CREATE TABLE IF NOT EXISTS `reponseassociee` (
  ...
  `VALEURDEV` smallint(6) DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
