<?php
include("back-end/ajout-question.php");
...
<body>
    ...
    <div class="box-ajout-question">
        <form method="post" action=<?php ajouterQuestion(); ?>>
            ...
            <div class="select-type-score">
                ...
                <input class ="little-button" type="submit" name="submit" value="Ajouter question">
            </div>
        </form>

    </div>
    <br>
    <button onclick="document.location.href= 'editeur.php'" class="add-question">Retour</button>
